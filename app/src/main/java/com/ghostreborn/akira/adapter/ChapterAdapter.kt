...
class ChapterAdapter(private val chapterList: ArrayList<String>) :
    ...
    class EpisodeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val chapterThumbnail: ImageView = itemView.findViewById(R.id.episode_thumbnail_image_view)
    }
    ...
    override fun onBindViewHolder(holder: EpisodeViewHolder, position: Int) {
        ...
        holder.chapterThumbnail.load(Constants.mangaThumbnail)
