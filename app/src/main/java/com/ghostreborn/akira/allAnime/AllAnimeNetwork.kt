...
class AllAnimeNetwork {
    ...
    fun searchAnime(anime: String): String? {
        ...
        val subDub = "sub"
        val variables =
            "\"search\":{\"allowAdult\":$allowAdult,\"allowUnknown\":$allowUnknown,\"query\":\"$anime\"},\"limit\":39,\"page\":1,\"translationType\":\"$subDub\",\"countryOrigin\":\"ALL\""
        val queryTypes =
    ...
    fun episodeDetails(id: String, episode: String): String? {
        ...
        val queryTypes =
            "\$showId:String!,\$episode:String!,\$translationType:VaildTranslationTypeEnumType!"
        val query =
            "episode(showId:\$showId,episodeString:\$episode,translationType:\$translationType){episodeString,episodeInfo{notes,thumbnails}}"
        return connectAllAnime(variables, queryTypes, query)
    }
